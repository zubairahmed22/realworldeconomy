					...
					<div className="row">
						<div className="col-sm-4">
							<div className="service_box hi-icon-effect-3 hi-icon-effect-3b">
								...
								<div className="service_details">
									<h5 className="font-color_base no_stripe"><a href="#">Travel and Aviation
									<br/>
									Consulting</a></h5>
								</div>
						...
						<div className="col-sm-4">
							<div className="service_box hi-icon-effect-3 hi-icon-effect-3b">
								...
								<div className="service_details">
									<h5 className="font-color_base no_stripe"><a href="#">Business Services
									<br/>
									Consulting</a></h5>
								</div>
								<div className="service_content">
						...
						<div className="col-sm-4">
							<div className="service_box hi-icon-effect-3 hi-icon-effect-3b">
								...
								<div className="service_details">
									<h5 className="font-color_base no_stripe"><a href="#">Consumer Products
									<br/>
									Consulting</a></h5>
								</div>
								<div className="service_content">
						...
						<div className="col-sm-4">
							<div className="service_box hi-icon-effect-3 hi-icon-effect-3b">
								...
								<div className="service_details">
									<h5 className="font-color_base no_stripe"><a href="#">Financial Services
									<br/>
									Consulting</a></h5>
								</div>
								<div className="service_content">
						...
						<div className="col-sm-4">
							<div className="service_box hi-icon-effect-3 hi-icon-effect-3b">
								...
								<div className="service_details">
									<h5 className="font-color_base no_stripe"><a href="#">Energy and Environment
									<br/>
									Consulting</a></h5>
								</div>
								<div className="service_content">
